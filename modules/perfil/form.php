...
if(isset($_SESSION['id_user']))
    {
        $query=pg_query($conn, "SELECT *FROM  usuarios WHERE id_user='$_SESSION[id_user]'")
        or die ('error'.pg_last_error($conn));
        $data=pg_fetch_assoc($query);
    }
?>
<section class="content-header">
  <h1><i class="fa fa-edit icon-title"></i> Modificar perfil de usuario</h1>
  <ol class="breadcrumb">
...
<div class="form-group">
  ...
  <div class="col-sm-5">
    ...
    <?php
    if ($data['foto'] == "") { ?>
      <img style="border:1px solid #eaeaea;border-radius:5px;" src="images/user/user-feaullt.png" widht="128">
    <?php
    } else { ?>
      <img style="border:1px solid #eaeaea;border-radius:5px;" src="images/user/<?php echo $data['foto']; ?>" widht="128">
    <?php
    }
    ?>
  </div>
