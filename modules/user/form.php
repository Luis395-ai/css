...
if ($_GET['form']=='add') { ?>
  <section class="content-header">
    <h1><i class="fa fa-edit icon-title"></i> Agregar Usuario</h1>
    <ol class="breadcrumb">
      <li><a href="mind.php"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="mind.php?module=user"> Usuario </a></li>
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="mind.php?module=user" class="btn btn-default btn-reset">Cancelar</a>
                </div>
              </div>
            </div>
          </form>
...
elseif ($_GET['form']=='edit') { 
    if (isset($_GET['id'])) {
      $query = pg_query($conn, "SELECT * FROM usuarios WHERE id_user='$_GET[id]'");
      $data  = pg_fetch_assoc($query);
    }	
?>
  <section class="content-header">
    <h1><i class="fa fa-edit icon-title"></i> Modificar Usuario</h1>
    <ol class="breadcrumb">
      <li><a href="mind.php"><i class="fa fa-home"></i> Inicio</a></li>
      <li><a href="mind.php?module=user"> Usuario </a></li>
          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/user/proses.php?act=update" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Nombre</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="name_user" value="<?php echo $data['name_user']; ?>" required>
                </div>
              </div>
